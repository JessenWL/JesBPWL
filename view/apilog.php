...
<!--===============================================================================================-->
					<thead>
						<tr class="row100 head">
							...
							<th class="column100 column2" data-column="column2">Id Code</th>
							<th class="column100 column3" data-column="column3">Program</th>
							<th class="column100 column4" data-column="column4">Nama</th>
							<th class="column100 column5" data-column="column5">Email</th>
							<th class="column100 column6" data-column="column6">SM1</th>
							<th class="column100 column7" data-column="column7">SM2</th>
							<th class="column100 column8" data-column="column8">SM3</th>
							<th class="column100 column9" data-column="column9">SM4</th>
							<th class="column100 column1" data-column="column1">Extra</th>
						</tr>
					</thead>
<!--===============================================================================================-->
					<?php
						...
						<tbody>
							<tr class="row100">
								...
								<td class="column100 column1" data-column="column1">
									<a href="apilog.php?id=<?php echo $x['id']; ?>&aksi=edit">Edit </a>
									<a href="../controller/proses.php?id=<?php echo $x ['id']; ?>&aksi=hapus">Delete</a></td>
							</tr>
						</tbody>
					<?php
						}
...
<!--===============================================================================================-->
								<?php
									if($login_button =='')
										...
										echo '<h3><b>Email :</b> '.$_SESSION['user_email_address'].'</h3><br></br>';
										echo '<h3><a href="logout.php" class="btn btn-primary">Logout</h3></div><br></br>';
										echo '<div><a href="\view\edit.php" class="btn btn-primary">Database Access</a></div>';
										}
									else
										{
